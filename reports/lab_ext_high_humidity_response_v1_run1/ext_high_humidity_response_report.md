...
- no_heat_runs：`3`
- no_heat_status_counts：`{'ext_high_hum_no_heat_breathing_watch': 1, 'ext_high_hum_no_heat_response_supported': 1, 'ext_high_hum_no_heat_response_negative': 1}`
- no_heat_supported_unsealed：`1`
- no_heat_negative_sealed：`1`
- no_heat_breathing_watch_sealed：`1`
- cooling_family_runs：`2`
- cooling_status_counts：`{'ext_high_hum_cooling_response_candidate': 1, 'ext_high_hum_cooling_no_segment': 1}`
...
- 2026-03-06 160246_seal_unheated | seal=seal | status=ext_high_hum_no_heat_breathing_watch | hits=5/6 | score=0.464 | features=corr_out_hum_in_hum,max_corr_outRH_inRH_change,frac_threshold_favored,frac_pos_delta_half_dAH,q90_delta_half_dAH_w | final_status=static_hard_case_watch
- 2026-03-03 181049_unseal_unheated | seal=unseal | status=ext_high_hum_no_heat_response_supported | hits=5/6 | score=0.371 | features=corr_out_hum_in_hum,max_corr_outRH_inRH_change,frac_threshold_favored,q90_delta_half_dAH_w,std_in_hum_run | final_status=static_dynamic_support_alert
...
- 2026-03-14 174006_unseal_heated | seal=unseal | cooling_windows=18 | status=ext_high_hum_cooling_response_candidate | frac_pos_dAH=0.6666666666666666 | q75_dAH=0.24756131017628408 | final_status=gated_heat_related
