...
- review_stage_counts：`{'05_transition_secondary': 4, '01_transition_primary': 3, '02_guarded_positive': 1, '03_breathing_watch': 1, '04_confound_watch': 1}`

## 输出文件

- template_csv: `reports/new_data_review_workflow_v1_run1/review_template_v2/segment_review_labels_template_v2.csv`
