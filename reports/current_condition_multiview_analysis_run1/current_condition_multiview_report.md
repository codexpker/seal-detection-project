...
- best_lag_h | auc=0.667 | direction=pos | seal_median=1.000 | unseal_median=1.000
...
- 当前最值得继续做静态分支探索的不是 `mean_out_h` 这类容易受实验条件影响的量，而是：`max_corr_outRH_inRH_change`、`q90_delta_half_dAH_w`、`frac_threshold_favored`、`frac_pos_delta_half_dAH`。
